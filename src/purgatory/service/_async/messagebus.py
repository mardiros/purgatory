...
CommandHandler = Callable[[Command, AsyncAbstractUnitOfWork], Coroutine[Any, Any, Any]]
EventHandler = Callable[[Event, AsyncAbstractUnitOfWork], Coroutine[Any, Any, None]]
