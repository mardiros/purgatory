...
def test_redis_respository_state_recovery(
    state,
    repository,
    sync_inmemory_repository: SyncInMemoryRepository,
    sync_redis_repository: SyncRedisRepository,
):
    repository = {"inmemory": sync_inmemory_repository, "redis": sync_redis_repository}[
        repository
    ]
...
def test_redis_respository_workflow(
    ...
    repository = {"redis": sync_redis_repository}[repository]
